...
replace github.com/tikv/client-go/v2 => github.com/River2000i/client-go/v2 v2.0.0-20250707091621-fdedc9c488e4

// replace github.com/tikv/client-go/v2 => /mnt/data/huangjiaqiang/client-go
